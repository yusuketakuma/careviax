...
- `tools/tests/.artifacts/screenshots/`
- `tools/tests/.artifacts/element-screens/`
- `tools/tests/.artifacts/results/`
- `tools/tests/.artifacts/audit/report/`
- `tools/tests/.artifacts/videos/`
- `tools/tests/.artifacts/snapshots/`
- `tools/tests/.artifacts/coverage/`（収集した場合のみ）
