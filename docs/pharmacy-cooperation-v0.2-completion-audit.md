...
| R-02       | Permission policy commonality       | Implemented for v0.2 boundaries                    | `canManagePatientSharing`, `canManageBilling`, active-share read predicates, patient-share correction/edit policy                                                             | Broader role-matrix browser proof after DB apply                        | In progress but sufficient for v0.2 surfaces                                                                 | P0       |
