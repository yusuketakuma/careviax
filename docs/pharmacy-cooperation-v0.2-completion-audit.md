...
| B-01       | Management plan/version evidence    | Implemented for v0.2 sharing boundary              | workflow references management plans; share-case creation validates approved same-patient plan/version snapshots                                                              | Direct DB-backed management-plan sharing proof after migration apply    | Existing management-plan services reused; patient-share API guards plan ownership/status/version             | P1       |
