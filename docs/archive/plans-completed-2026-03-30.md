# Plans.md 完了セクション アーカイブ

> アーカイブ日: 2026-03-30
> 元ファイル: Plans.md
> 対象: `cc:完了` が付いたセクション（直近トラック / Phase 0-1〜0-2 / Phase 1a / Phase 1b / Phase 2 / Phase 2b / Phase 2c の完了分）
...
## Phase 0: 0-2. データモデル全体（Prisma Schema） `cc:完了`
...
## Phase 1a: 1a-7. モバイル/タブレットUI `cc:完了`
...
## Phase 1b: 1b-1. ① 処方箋応需（処方受付〜調剤開始前） `cc:完了`
...
## Phase 1b: 1b-4. トレーシングレポート + 依頼/照会ワークフロー `cc:完了`
...
## Phase 1b: 1b-5. 最小セット運用（Pilot前必須） `cc:完了`
...
## Phase 2b: 2b-4. スケジュール提案機能の拡張 `cc:完了`
...
## Phase 2b: 2b-6. 訪問時音声認識機能 `cc:完了` (2026-03-30)
