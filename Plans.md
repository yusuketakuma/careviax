...
1. `PERF-DB-006` care-report bounded search / EXPLAIN-backed index backlog。
2. `PAYLOAD-BUDGET-001` movement / dashboard / inbound list DTO の payload-size smoke と PHI omission snapshot。
