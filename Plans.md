...
| --------------- | ------ | ------------------------------------------------------------------------- | ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| MOD-BOUND-001   | P0/P1  | `boundaries:check`, `DEV-REF-001`, `PLAN-REV-001`                         | Registry-driven module boundary gate | structured allowlist schema、owner/debtId/plannedAction、owner別ratchet report、CI接続は完了。残: allowlist count を減らす実際の依存反転と、module public entrypoint 例外の追加テスト拡張。                                                                                              | 新規 core -> pharmacy / sibling module import / API route から module internal import が fail。`src/modules/active-modules.ts` は composition root として明示許可。既存 allowlist count はPRごとに減らす、または増やさない。 |
