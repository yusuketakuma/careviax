...
1. `FILE-COMPLETE-001` / `COMM-FILE-001` / `FILE-DOWNLOAD-001`: 完了済み。次の file/export PHI slice は `FILE-001` / `DEV-PHI-001` の snapshot breadth、download proxy/streaming 検討、retention guard へ進める。
