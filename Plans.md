...
| FE-RT-002      | P0/P1  | `NTF-STREAM-001`, `SEC-001`, `DEV-PHI-001`                     | Realtime client payload schema hardening      | 残: server側 normalizer / notification stream policy と snapshot coverage を合わせる。                                                                                                                                                                                                                          | SSE payload に patient name、住所、電話、薬剤名、raw message、metadata、provider error、storage key、signed URL が混じっても React state に入らない。                                                                     |
