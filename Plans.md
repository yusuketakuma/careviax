...
3. `INBOUND-002-REVIEW-DETAIL`: raw detail API + audited detail panel は完了。残は 3カラム review shell と review action lifecycle UI。
...
| `INB-001/002`   | Formal inbound schema/API/inbox/signals/task/risk/stock apply、raw detail再認可API/read audit、audited detail panel、dashboard raw omission。                                                                                                     | 3カラム review shell、review lifecycle UI、MedicationStock apply UI、FAX/email/manual、source mapping UI、VisitBrief/Schedule/Report/Share。                                                              |
...
| ---------------------------------- | ----------- | -------- | ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `INBOUND-002-REVIEW-DETAIL`        | Partial     | P0/P1    | Inbound UI/API    | raw detail API と既存 review panel の audited raw表示は完了。残は 3カラム review shell、左=原文/添付/送信者/日時、中央=signal候補、右=反映先/Task/Record-only/Reject/MedicationStock の作業面化。raw_textは既存 detail API とread audit経由に限定。               | raw omission snapshots、review lifecycle、MedicationStock apply UI tests。raw_textをlist/通知/監査changesへ流すなら停止。                              |
...
| ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `INBOUND-002-REVIEW-DETAIL`    | raw detail API と既存 review panel の audited raw表示は完了。次は 3カラム shell 化し、review action lifecycle と MedicationStock apply 導線を UI で閉じる。                                                                                                                                                                                                     | Inbound schema、phone/MCS登録、inbox、signal materialize、task/risk bridge、MedicationStock apply、raw detail API、audited detail panel。 | list DTO raw omission snapshot、review action lifecycle、MedicationStock apply allowed/forbidden。                                                                      |
