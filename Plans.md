...
3. `INBOUND-002-REVIEW-DETAIL`: raw detail API、audited detail panel、review lifecycle、MedicationStock適用条件/不可表示、source detail layout、audited apply target selector は完了。残は FAX/email/manual、source mapping、downstream導線。
