...
const E2E_ENV = {
  ...process.env,
  DATABASE_URL: 'postgresql://careviax:careviax@localhost:5433/careviax_e2e?schema=public',
  DIRECT_URL: 'postgresql://careviax:careviax@localhost:5433/careviax_e2e?schema=public',
  PLAYWRIGHT: '1',
  AUTH_SECRET: 'careviax-local-auth-secret',
  NEXTAUTH_SECRET: 'careviax-local-auth-secret',
