...
Sections 12 and 13 (the block-library contract and scope exclusions) continue in
`references/appendices.md` and remain mandatory.
...
Before using this skill, read `references/appendices.md` completely.
