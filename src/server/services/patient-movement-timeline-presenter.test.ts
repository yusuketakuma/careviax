...
describe('patient-movement-timeline-presenter', () => {
  ...
  it.each([
    ...
    ['backslash authority', '/\\storage.example.com/private/rx.pdf'],
    ['control authority', '/\n/storage.example.com/private/rx.pdf'],
    ...
    ['encoded api', '/%61pi/patients/patient_1/movement-timeline'],
    ['normalized api', '/safe/%2e%2e/api/patients/patient_1/movement-timeline'],
