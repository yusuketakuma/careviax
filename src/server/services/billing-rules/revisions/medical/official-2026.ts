...
export const MEDICAL_2026_OFFICIAL_SITE_CONFIG_POINTS = {
  ...
  electronicDispensingInfoCollaboration: 8,
...
export const MEDICAL_2026_OFFICIAL_RULE_POINTS = {
  ...
  MED_ADVERSE_EVENT_KAKARITSUKE_CHANGE: 50,
  MED_ADVERSE_EVENT_OTHER_CHANGE: 30,
  MED_RESIDUAL_ADJUSTMENT_HOME_PROPOSAL: 50,
  MED_RESIDUAL_ADJUSTMENT_HOME: 50,
  MED_RESIDUAL_ADJUSTMENT_KAKARITSUKE: 50,
  MED_RESIDUAL_ADJUSTMENT_OTHER: 30,
  ...
  MED_KAKARITSUKE_VISIT_ADDITION: 230,
  MED_KAKARITSUKE_FOLLOWUP_ADDITION: 50,
  MED_MEDICATION_ADJUSTMENT_SUPPORT_2: 1000,
  ...
  MED_DISPENSING_BASE_UP_EVALUATION: 4,
  MED_DISPENSING_PRICE_RESPONSE: 1,
  MED_ELECTRONIC_DISPENSING_INFO_COLLABORATION: 8,
} as const;
