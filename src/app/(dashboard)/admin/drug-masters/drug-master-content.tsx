...
import { baseColumns, StructuredPayload } from './drug-master-content-columns';
import {
  CATEGORY_OPTIONS,
                            ...
                            <div className="flex flex-wrap gap-2">
                              <LoadingButton
                                ...
                                loading={
                                  ...
                                  stockRequestDecisionMutation.variables?.request_id ===
                                    request.id &&
                ...
                <>
                  <div className="mt-3 grid gap-2 md:grid-cols-3">
                    <div className="rounded-md border border-border/60 bg-background px-3 py-2">
                      ...
                      <p className="mt-1 text-2xl font-semibold tabular-nums">
                        {(
                          formularyUsageMismatch?.totals.medication_line_count ?? 0
                        ).toLocaleString()}
                      </p>
                    </div>
                    <div className="rounded-md border border-border/60 bg-background px-3 py-2">
                        ...
                        formularyUsageMismatch?.frequent_unstocked.slice(0, 3).map((item) => (
                          ...
                          >
                            ...
                            <span className="mt-1 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                              {item.drug_code && (
                                <span className="font-mono">{item.drug_code}</span>
                              )}
                          ...
                          >
                            ...
                            <span className="mt-1 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                              ...
                              {(stock.drug_master.is_narcotic ||
                                stock.drug_master.is_psychotropic) && <span>規制薬</span>}
                            ...
                            >
                              ...
                              <span className="flex items-center gap-2 text-muted-foreground">
                                ...
                                <Button
                                  ...
                                  onClick={async () => {
                                    try {
                                      await copyTextToClipboard(candidate.yj_code);
