...
import { getReportShareWorkspaceTestSupport } from './report-share-workspace.test-support';
...
} = getReportShareWorkspaceTestSupport();

export function registerReportShareWorkspaceCases() {
