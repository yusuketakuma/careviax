...
async function firstVisitDocumentPATCH(
  req: NextRequest,
  ctx: AuthContext,
  ...
  return withSensitiveNoStore(
    success({ data: toSafeFirstVisitDocumentMutationResponse(result.document) }),
  );
}

export const PATCH = withAuthContext(firstVisitDocumentPATCH, {
  permission: 'canVisit',
