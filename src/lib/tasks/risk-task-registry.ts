...
import type { RiskTaskRegistryEntry, RiskTaskResolveCondition } from './task-registry.types';
...
export const RISK_TASK_REGISTRY = {
  ...
  task_sla: {
    ...
    resolve_condition: { strategy: 'manual_or_waiver_only', requires_related_entity: true },
  },
  notification: {
