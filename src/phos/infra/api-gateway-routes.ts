...
export const PHOS_API_ROUTES = [
  {
    ...
    method: 'GET',
    path: '/cards',
    lambda_handler: '@/phos/backend/cards-handlers#createCardSearchHandler',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/cards/{card_id}',
    lambda_handler: '@/phos/backend/cards-handlers#createCardDetailHandler',
    required_scopes: ['phos/cards.read'],
    requires_idempotency_key: false,
    requires_expected_version: false,
  ...
  },
  {
    ...
    lambda_handler: '@/phos/backend/cards-handlers#createExecuteCardActionHandler',
  ...
  },
  {
    ...
    lambda_handler: '@/phos/backend/evidence-handlers#createEvidencePresignUploadHandler',
