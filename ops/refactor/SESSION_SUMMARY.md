...
- Current implementation: notification-bell, prescriber-institutions, packaging-method, master-hub, vehicle, and operating-hours readers use strict schemas; operating-hours regressions and shared site-option stripping are validated and landed.
...
- Remaining: rescan the remaining API-CONTRACT-001 allowlist and patients board cursor residual, select the next bounded slice, and preserve provider/auth semantics, mutation/audit behavior, authorized in-app detail, and external-output boundaries.
