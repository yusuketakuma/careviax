...
- Current implementation: notification-bell, prescriber-institutions, packaging-method, master-hub, vehicle, operating-hours, service-areas, and MentionInput staff lookup readers use strict schemas; MentionInput minimal pharmacist schema, 34 focused tests, full gates, and Next build are landed in `55ffe485a`.
