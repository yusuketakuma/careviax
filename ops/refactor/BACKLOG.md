...
| `PERF-01` | perf O(n²)     | CSV バルク在庫インポートの preview 行→operation 照合が nested .find() で O(N²)。rowNumber キー Map 化で O(N)、出力形状不変                                                                                                                                                                                                                                    | pharmacy-drug-stocks/bulk/route.ts:541-551            | 5    | 4    | 5          | いいえ   | open                    |
