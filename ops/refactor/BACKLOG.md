...
| R46 | 17    | pattern-inconsistency (S) | `buildCursorPage`未採用の手組みhasMore/slice/nextCursorが約20ルートに残存。billing-candidates の単純 cursor envelope は helper 収束済み(b4185e59)。medication-cycles の numeric offset cursor envelope も helper 収束済み(c8f03405)。consent-records の PHI-redacted cursor envelope も helper 収束済み(fd774353)。`meta.has_more`/keyset/scan-window/hidden-count/summary variants は個別分析を継続。 | partial(b4185e59+c8f03405+fd774353) |
