...
| R32 | 19    | test-harness-dup (S)      | QueryClientテストwrapperが52テストファイルで73回重複、retry-config drift。platform tenant 4テスト・admin 16テスト・patient/visit 4テストを `createQueryClientWrapper` へ移行済み。                                                                                                                                                             | partial(b8466684,fa0fa895,0bd86e3f,7d9ef657,b92abbfb,e7965d31) |
