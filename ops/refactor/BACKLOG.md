...
| R10 | 20    | dup-helper (M)            | blocked_reasons→BlockedReason[] rail mapping は `buildDailyOpsBlockedReasons` へ収束済み。残: buildWorkspaceNextAction準コピー2箇所                                                                                                                                                                                                           | in-progress(ac8aa952)            |
