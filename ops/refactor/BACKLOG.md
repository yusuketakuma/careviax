...
| R32 | 19    | test-harness-dup (S)      | QueryClientテストwrapperが52テストファイルで73回重複、retry-config drift。platform tenant 4テストと admin 4テストを `createQueryClientWrapper` へ移行済み。                                                                                                                                                                                    | partial(b8466684,fa0fa895)       |
