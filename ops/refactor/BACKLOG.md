...
| R23 | 20    | dup-helper (M)            | `messageFromError(e, fallback)`抽出候補 — 同型ternaryが174箇所/66ファイルに重複（141箇所はtoast.error内）。既存 `src/lib/utils/error-message.ts` を使い、prescription intake submit/form の2箇所を収束し empty Error message fallback を test-locked(a510f2c2)。patient form、dispense workbench、schedule proposals、print hub、search、audit logs、drug master import preview、patient medications add-dialog、billing rules JSON validation の query/mutation/print-history/search/export/import-preview/add-dialog/validation error formatting も helper へ収束(a47b52fa,ad956006,6d098a9b,42d866e3,4f1c7321,872624db,fea1cd37,318f04d1,8c3b18aa)。 | partial(a510f2c2+a47b52fa+ad956006+6d098a9b+42d866e3+4f1c7321+872624db+fea1cd37+318f04d1+8c3b18aa) |
