...
| R25 | 20    | pattern-inconsistency (M) | ErrorState retry定型句(`action={{label:'再試行'...}}`)が106箇所で手組み。`ErrorState.retryLabel` を追加し admin analytics/realtime の5箇所(2e8589a4)、admin performance の5箇所(1ea41977)、patient medications の5箇所(06430afb)、prescription intake の4箇所(b9a55665)、admin operating-hours の3箇所(a33d3c0b)、admin drug-masters の3箇所(06784c51)、admin business-holidays の2箇所(e42242d2)、admin pharmacy-sites の2箇所(176035a0)、admin data-explorer の2箇所(b9095cfa)、dispense patient-list ErrorState の1箇所(596afee7)、schedule calendar の2箇所(7461d41f)、route/global error boundary の2箇所(823307ae; `retryVariant` 追加で outline 維持)、statistics KPI の2箇所(00344de5; `retrySize` 追加で compact button 維持)を `onRetry` shorthand へ移行済み。残: 他画面の段階移行。 | partial(2e8589a4+1ea41977+06430afb+b9a55665+a33d3c0b+06784c51+e42242d2+176035a0+b9095cfa+596afee7+7461d41f+823307ae+00344de5) |
