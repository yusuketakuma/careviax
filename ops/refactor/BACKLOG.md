...
| R32 | 19    | test-harness-dup (S)      | QueryClientテストwrapperが52テストファイルで73回重複、retry-config drift。platform tenant 4テスト・admin 16テスト・patient/visit 4テスト・shared/comment/billing 4テスト・select/schedule 4テスト・reports/handoff 4テスト・schedule/nav 4テストを `createQueryClientWrapper` へ移行済み。                                                   | partial(b8466684,fa0fa895,0bd86e3f,7d9ef657,b92abbfb,e7965d31,96e099e9,cdf6067a,1258009e,0ec765bf) |
