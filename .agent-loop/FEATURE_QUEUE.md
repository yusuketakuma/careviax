...
| S4    | claude       | codex    | 稼働日設定 UI（§13.1 月グリッド + 週次営業時間エディタ）。business-holidays 完全統合(§13.2)/プリセット/R3 は後続へ分離                     | なし（S3 後）    | **patch_ready** b64129bc（vitest 5 + 全 gate green、codex review 待ち）。ナビ=案B shortcut 暫定、master-hub カード(案A)は codex 後続                                                                                                                                                                                                                           |
