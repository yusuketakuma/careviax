...
```bash
sed 's/<task-id>/QL-20260620-001/' implementation-decision.md | gbrain put projects/careviax/decisions/api-client-consolidation
# or simply:  gbrain put projects/careviax/decisions/<id> < filled.md
```
